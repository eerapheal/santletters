...
const PricingCard = ({ active }: { active: string }) => {
  return (
    <div className="w-full flex flex-wrap items-start justify-around py-8">
      {/* free plan */}
      <div className="md:w-[400px] h-[525px] flex  flex-col justify-between bg-white rounded p-5 my-5 lg:my-0">
        <div>
          <div className="flex justify-between pb-2 border-b border-[#000]">
            <svg
        ...
        <div>
          ...
          <p className="pt-1 opacity-[.7] font-[400] text-center">
            30-day free trial of GOLD features, then free
          </p>
        </div>
      </div>

      {/* Silver plan */}
      <div className="md:w-[400px] flex flex-col justify-between h-[525px] bg-white rounded p-5 my-5 lg:my-0">
        <div>
          <div className="flex justify-between pb-2 border-b border-[#000]">
            <svg
              xmlns="http://www.w3.org/2000/svg"
